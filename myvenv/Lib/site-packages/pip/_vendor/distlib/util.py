...
class FileOperator(object):
    ...
    def newer(self, source, target):
        ...
        Note that this test_pyqt is not very accurate: files created in the same
...
class Cache(object):
    ...
    could be used by other modules, e.g. the wheel modules.
    """
...
#
# CSV functionality. This is provided because on 2.x, the csv modules can't
